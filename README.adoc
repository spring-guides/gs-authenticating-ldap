...
It is also possible to inject a `Principle` object containing details of the logged-in user.
...
Change the URL in your browser's address bar to http://localhost:8080/home, and you'll get a more personal message:

....
Welcome to your home page, ben!
....
